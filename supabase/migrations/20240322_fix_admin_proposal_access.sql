...
drop policy if exists "Admin users can view all proposals" on public.proposals;
drop policy if exists "Admin users can update all proposals" on public.proposals;
