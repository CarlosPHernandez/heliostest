...
drop policy if exists "Enable users to update own proposals" on public.proposals;
drop policy if exists "Enable admin to update all proposals" on public.proposals;
drop policy if exists "Admins can update project status" on public.proposals;
...
-- Only admins can update project status and stage
